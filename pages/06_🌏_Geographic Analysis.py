...
df5 = df1.groupby([ 'Order Country', 'Order City'])['Order Profit Per Order'].sum().reset_index(name='Order Profit Per Order').sort_values(by= 'Order Profit Per Order', ascending= True)
